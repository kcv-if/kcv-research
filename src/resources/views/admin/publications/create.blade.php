...
<form action="/admin/publications" method="post" class="mb-3">
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" placeholder="Excerpt" id="excerpt" name="excerpt" required value="{{ old('excerpt') }}"></textarea>
  </div>

  {{-- Abstract --}}
  <div class="mb-3">
    <label for="abstract" class="form-label">Abstract</label>
    <textarea class="form-control" placeholder="Abstract" id="abstract" name="abstract" required value="{{ old('abstract') }}"></textarea>
  </div>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="users" name="users" placeholder="Search Authors">
