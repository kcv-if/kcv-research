  ...
  <tbody>
    @foreach ($datasets as $dataset)
      <tr>
        ...
        <td>
          {{-- Show --}}
          <a href="/admin/datasets/{{ $dataset->id }}" class="badge bg-info"><i class="bi bi-eye"></i></a>
          ...
          {{-- Review --}}
          <a href="/admin/datasets/{{ $dataset->id }}/review" class="badge bg-primary"><i class="bi bi-hand-thumbs-up"></i></a>
